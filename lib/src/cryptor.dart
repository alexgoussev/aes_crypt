...
class _Cryptor {
  ...
  Uint8List _passBytes = Uint8List(0);
  AesCryptOwMode _owMode = AesCryptOwMode.on;
  ...
  _Cryptor.init(Uint8List? passBytes, AesCryptOwMode mode,
    ...
    _passBytes = passBytes != null
        ? Uint8List.fromList(passBytes.toList())
        : Uint8List(0);
    _owMode = mode;
  ...
  String encryptDataToFileSync(Uint8List srcData, String destFilePath) {
    ...
    _encryptDataAndCalculateHmac(
        srcData,
        _dp.putIfAbsent(_Data.key2, () => Uint8List(0)),
        _dp.putIfAbsent(_Data.iv2, () => Uint8List(0)),
        AesMode.cbc);
    ...
    try {
      _Chunks.forEach((c) {
        if (_dp[c] != null) {
          raf.writeFromSync(_dp[c]!.toList());
        }
      });
    } on FileSystemException catch (e) {
      raf.closeSync();
  ...
  String encryptFileSync(String srcFilePath, String destFilePath) {
    ...
    _encryptDataAndCalculateHmac(
        ...
        _dp.putIfAbsent(_Data.iv2, () => Uint8List(0)),
        AesMode.cbc);
    _dp[_Data.hmac2] = hmacSha256(
      _dp.putIfAbsent(_Data.key2, () => Uint8List(0)),
      _dp.putIfAbsent(_Data.encdata, () => Uint8List(0)),
    );
  ...
  Uint8List decryptDataFromFileSync(String srcFilePath) {
    ...
    _validateHMAC(keys.putIfAbsent(_Data.key2, () => Uint8List(0)),
        encrypted_data, hmac_2, _HmacType.HMAC2);

    _aes.aesSetParams(_dp.putIfAbsent(_Data.key2, () => Uint8List(0)),
        _dp.putIfAbsent(_Data.iv2, () => Uint8List(0)), AesMode.cbc);
  ...
  Future<Uint8List> decryptDataFromFile(String srcFilePath) async {
    ...
    _validateHMAC(_dp.putIfAbsent(_Data.key2, () => Uint8List(0)),
        encrypted_data, hmac_2, _HmacType.HMAC2);
  ...
  String decryptFileSync(String srcFilePath, String destFilePath) {
    ...
    _aes.aesSetParams(keys.putIfAbsent(_Data.key2, () => Uint8List(0)),
        keys.putIfAbsent(_Data.iv2, () => Uint8List(0)), AesMode.cbc);
    final Uint8List decrypted_data_full = _aes.aesDecrypt(encrypted_data);
...
//****************************************************************************
  ...
  Uint8List sha256(Uint8List data, [Uint8List? hmacIpad]) {
    ...
    Uint8List chunkLast = Uint8List(0);
    Uint8List chunkLastPre = Uint8List(0);
    int chanksToProcess = 0;
...
//****************************************************************************
  ...
  void _createDataParts() {
    ...
    _dp[_Data.key1] =
        _keysJoin(_dp.putIfAbsent(_Data.iv1, () => Uint8List(0)), _passBytes);
    ...
    _aes.aesSetParams(_dp.putIfAbsent(_Data.key1, () => Uint8List(0)),
        _dp.putIfAbsent(_Data.iv1, () => Uint8List(0)), AesMode.cbc);
    _dp[_Data.enckeys] = _aes.aesEncrypt(_dp
        .putIfAbsent(_Data.iv2, () => Uint8List(0))
        .addList(_dp.putIfAbsent(_Data.key2, () => Uint8List(0))));
    _log('ENCRYPTED KEYS', _dp[_Data.enckeys]);

    // Calculate HMAC1 using the first enc key
    _dp[_Data.hmac1] = hmacSha256(
      _dp.putIfAbsent(_Data.key1, () => Uint8List(0)),
      _dp.putIfAbsent(_Data.enckeys, () => Uint8List(0)),
    );
  ...
  int _readChunkIntSync(RandomAccessFile f, int num_bytes, String chunk_name,
    ...
    if (expected_value != 0 && result != expected_value) {
      throw AesCryptDataException(
